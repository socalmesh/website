...
**What to expect.** We are volunteers, so we cannot promise a response time.
We will read every report, and we will tell you what we decided to do about it.

**What is in scope:** this repository and the website it publishes.
**What is not:** the Meshtastic firmware or apps (report those to the
Meshtastic project), Discord itself, and the maps run by other people.
